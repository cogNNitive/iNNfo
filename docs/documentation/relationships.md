...
En iNNfo, las relaciones entre elementos y conceptos se clasifican en **4 niveles formales** (alineados con la Especificación Nivel 1 `iNNfo_NN.md`), dependiendo de su origen y grado de estructuración.
