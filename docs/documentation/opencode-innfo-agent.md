...
>
> Instead of maintaining agent rules in this repo, install the full actioNN suite — it includes the `nn-innfo` skill plus router, trannsform, workflow orchestrator, and more.
