...
Built with the [cogNNitive Web Design Guide](https://skills.innv0.com/innv0-web-design-guide) design system.
...
|-----------|-------------|
| `apps/innfo-editor` | Vue 3 workspace editor Ã¢â‚¬” the iNNfo Modeler |
...
This site was generated by an AI agent following the [cogNNitive Web Design Guide](https://skills.innv0.com/innv0-web-design-guide).
...
- Open the browser dev tools console Ã¢â‚¬” there should be no 404 errors for JS/CSS assets
